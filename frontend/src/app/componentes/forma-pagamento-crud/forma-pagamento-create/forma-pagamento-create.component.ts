...
<mat-card class="content">
    <div class="content">
      <mat-card-title class="centralizar-texto">Nova Forma de Pagamento</mat-card-title>
        <form>
          <mat-form-field>
        ...
        <div class="centralizar">
          <button class="btn-verde" mat-raised-button (click)="criarFormaPagamento()">
              Salvar
          </button>
...
export class FormaPagamentoCreateComponent implements OnInit {
  ...
  criarFormaPagamento(): void {
    this.formaPagamentoService.criar(this.formaPagamento).subscribe(() => {
      this.geralService.snackBarMensagem(`A forma de pagamento ${this.formaPagamento.forma} foi cadastrada com sucesso!`)
